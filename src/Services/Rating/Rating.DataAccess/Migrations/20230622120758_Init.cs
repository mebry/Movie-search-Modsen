        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AverageRating = table.Column<double>(type: "float", maxLength: 10, nullable: false),
                    CountOfScores = table.Column<long>(type: "bigint", nullable: false),
                    OldCountOfScores = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
